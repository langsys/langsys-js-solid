...
| Suite                       | **81 tests / 9 files**, all passing — 78 browser-build + 3 SSR-build                                                                            |
...
Each new behaviour was mutated to confirm its test actually catches it. All eight mutations were
...
npm test                            # 81 tests / 9 files — runs BOTH projects
